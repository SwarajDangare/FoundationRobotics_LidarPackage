...
pub fn main() {
    bevy::app::App::new()
        ...
        .add_systems(Update, raycast::cast_ray_system) // Pass the system function directly
        .add_systems(Update, raycast::setup_raycast_system) // Pass the system function directly
...
fn setup(
    ...
    let wall_length = 4.0;
    let wall_color = Color::rgb(0.0, 0.0, 0.5);
    ...
    // Obj 1
    commands
        .spawn(Collider::cylinder(0.1, 0.1))
        .insert(CollisionGroups::new(
            STATIC_GROUP,
            CHASSIS_INTERNAL_GROUP | CHASSIS_GROUP,
        ))
        .insert(PbrBundle {
            mesh: meshes.add(Mesh::from(Cylinder::new(0.1, 0.2))),
            material: materials.add(Color::rgba(0.9, 0.0, 0.0, 1.0)),
            transform: Transform::from_xyz(0.7, 0.1, 0.0),
            ..default()
        })
    ...
    commands
        ...
        .insert(PbrBundle {
            mesh: meshes.add(Mesh::from(Cylinder::new(0.1, 0.2))),
            material: materials.add(Color::rgba(0.0, 0.9, 0.0, 1.0)),
            transform: Transform::from_xyz(-0.7, 0.1, -0.7),
            ..default()
        })
        .insert(PickableBundle::default());
    ...
    commands
        ...
        .insert(PbrBundle {
            mesh: meshes.add(Mesh::from(Cylinder::new(0.1, 0.2))),
            material: materials.add(Color::rgba(0.0, 0.0, 0.9, 1.0)),
